<template>
  <div>
    ...
    <p>Last updated: Septemberr 09, 2020</p>

    <p>
      Please read these Terms of Use ("Terms", "Terms of Use") carefully before
      using the https://pooltool.io website (the "Service") operated by PoolTool
      ("us", "we", or "our").
    </p>
    ...
    <p>
      ...
      Service. The Terms of Use agreement for PoolTool has been created with the
      help of
    ...
    <p>
      ...
      are not owned or controlled by PoolTool.
    </p>

    <p>
      PoolTool has no control over, and assumes no responsibility for, the
      content, privacy policies, or practices of any third party web sites or
      services. You further acknowledge and agree that PoolTool shall not be
